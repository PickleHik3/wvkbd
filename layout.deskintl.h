...
static struct layout layouts[NumLayouts] = {
  ...
  [ComposeAltGr] = {keys_compose_altgr, "latin"},
...
static struct key keys_full[] = {
  ...
  {"7", "&", 0.9, Code, KEY_7},
  {"8", "*", 0.9, Code, KEY_8},
  {"9", "(", 0.9, Code, KEY_9, &layouts[ComposeBracket]},
  {"0", ")", 0.9, Code, KEY_0, &layouts[ComposeBracket]},
  {"-", "_", 0.9, Code, KEY_MINUS, &layouts[ComposeBracket]},
  {"=", "+", 0.9, Code, KEY_EQUAL, &layouts[ComposeBracket]},
  {"Del", "Del", 1.0, Code, KEY_DELETE, .scheme = 1},
  {"⌫", "⌫", 1.7, Code, KEY_BACKSPACE, .scheme = 1},
  {"", "", 0.0, EndRow},
  ...
  {".", ">", 0.75, Code, KEY_DOT, &layouts[ComposePunctuation]},
  {"/", "?", 0.75, Code, KEY_SLASH},
  ...
  {"", "", 6.5, Code, KEY_SPACE},
  {"AGr", "AGr", 1.0, Layout, 0, &layouts[ComposeAltGr], .scheme = 1},
...
static struct key keys_special[] = {
  ...
  {"Abc", "Abc", 1.5, Layout, 0, &layouts[Full], .scheme = 1},
  {"Абв", "Абв", 1.5, Layout, 0, &layouts[Cyrillic], .scheme = 1},
  {"Alt", "Alt", 1.0, Mod, Alt, .scheme = 1},
  {"", "", 6.5, Pad},
  {"AGr", "AGr", 1.0, Layout, 0, &layouts[ComposeAltGr], .scheme = 1},
  {"←", "←", 1.0, Code, KEY_LEFT, .scheme = 1},
...
static struct key keys_cyrillic[] = {
  ...
  {"т", "Т", 1.0, Code, KEY_N},
  {"ь", "Ь", 1.0, Code, KEY_M},
  {"б", "Б", 0.75, Code, KEY_COMMA},
  {"ю", "Ю", 0.75, Code, KEY_DOT},
  {"/", "?", 0.75, Code, KEY_SLASH, &layouts[ComposePunctuation]},
  {"↑", "↑", 1.0, Code, KEY_UP, .scheme = 1},
  {"⇧", "⇫", 2.0, Mod, Shift, .scheme = 1},
  {"", "", 0.0, EndRow},
...
static struct key keys_compose_altgr[] = {
  {"@", "@", 1.0, Code, KEY_S, 0, AltGr},
  {"~", "~", 1.0, Code, KEY_L, 0, AltGr},
  {"\\", "\\", 1.0, Code, KEY_COMMA, 0, AltGr},
  {"|", "|", 1.0, Code, KEY_DOT, 0, AltGr},
  {"EUR", "EUR", 1.0, Code, KEY_MINUS, 0, AltGr},
  {"GBP", "GBP", 1.0, Code, KEY_EQUAL, 0, AltGr},
  {"", "", 4.0, Pad},
  {"", "", 0.0, EndRow},
  {"-", "-", 1.0, Code, KEY_A, 0, AltGr},
  {"*", "*", 1.0, Code, KEY_D, 0, AltGr},
  {"^", "^", 1.0, Code, KEY_F, 0, AltGr},
  {":", ":", 1.0, Code, KEY_G, 0, AltGr},
  {";", ";", 1.0, Code, KEY_H, 0, AltGr},
  {"(", "(", 1.0, Code, KEY_J, 0, AltGr},
  {")", ")", 1.0, Code, KEY_K, 0, AltGr},
  {"", "", 3.0, Pad},
  {"", "", 0.0, EndRow},
  {"/", "/", 1.0, Code, KEY_Z, 0, AltGr},
  {"'", "'", 1.0, Code, KEY_X, 0, AltGr},
  {"\"", "\"", 1.0, Code, KEY_C, 0, AltGr},
  {"+", "+", 1.0, Code, KEY_V, 0, AltGr},
  {"=", "=", 1.0, Code, KEY_B, 0, AltGr},
  {"?", "?", 1.0, Code, KEY_N, 0, AltGr},
  {"!", "!", 1.0, Code, KEY_M, 0, AltGr},
  {"", "", 3.0, Pad},
  {"", "", 0.0, EndRow},
  {"Abc", "Abc", 1.0, BackLayer, .scheme = 1},
  {"", "", 9.0, Pad},
